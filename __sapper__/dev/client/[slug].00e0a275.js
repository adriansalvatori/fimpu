import { S as SvelteComponentDev, i as init, s as safe_not_equal, d as dispatch_dev, w as validate_each_argument, x as onMount, v as validate_slots, e as element, b as space, h as claim_element, j as children, f as claim_space, c as detach_dev, l as attr_dev, n as add_location, o as insert_dev, p as append_dev, r as listen_dev, u as noop, y as destroy_each, z as run_all, t as text, k as claim_text, A as create_component, B as claim_component, C as mount_component, D as transition_in, E as transition_out, F as destroy_component, G as group_outros, H as check_outros, q as query_selector_all, m as set_style } from './client.b82d62db.js';
...
function create_if_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a, "class", "button is-rounded is-primary is-uppercase has-pdf svelte-xjrdx");
			add_location(a, file$1, 59, 8, 1775);
			attr_dev(div, "class", "pdf-trigger");
			add_location(div, file$1, 58, 4, 1740);
		},
		m: function mount(target, anchor) {
			insert_dev(target, div, anchor);
			append_dev(div, a);
...
function create_fragment$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(a, "target", "_blank");
			attr_dev(a, "class", "button is-rounded is-primary is-uppercase has-iframe svelte-xjrdx");
			...
			add_location(iframe, file$1, 45, 8, 1310);
			attr_dev(div0, "class", "iframe-container svelte-xjrdx");
			add_location(div0, file$1, 43, 4, 1144);
			attr_dev(button, "class", "button is-rounded is-primary is-uppercase has-gallery svelte-xjrdx");
			add_location(button, file$1, 52, 8, 1527);
			attr_dev(div1, "class", "gallery-trigger");
			add_location(div1, file$1, 51, 4, 1488);
