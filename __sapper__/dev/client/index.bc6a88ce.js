import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, b as space, h as claim_element, j as children, c as detach_dev, k as claim_text, f as claim_space, l as attr_dev, n as add_location, m as set_style, o as insert_dev, p as append_dev, u as noop } from './client.1d41c618.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i0, file, 27, 155, 1007);
			attr_dev(span0, "class", "icon is-small");
			add_location(span0, file, 27, 127, 979);
			add_location(span1, file, 27, 192, 1044);
			attr_dev(a0, "href", "/medios/mintic");
			attr_dev(a0, "class", "button is-rounded is-primary is-uppercase has-text-weight-bold is-control svelte-142tj0s");
			add_location(a0, file, 27, 20, 872);
			attr_dev(i1, "data-feather", "share-2");
			add_location(i1, file, 28, 153, 1230);
			attr_dev(span2, "class", "icon is-small");
			add_location(span2, file, 28, 125, 1202);
			add_location(span3, file, 28, 190, 1267);
			attr_dev(a1, "href", "/medios/rtvc");
			attr_dev(a1, "class", "button is-rounded is-primary is-uppercase has-text-weight-bold is-control svelte-142tj0s");
			add_location(a1, file, 28, 20, 1097);
			attr_dev(div0, "class", "column is-2");
			add_location(div0, file, 26, 16, 825);
			attr_dev(i2, "data-feather", "share-2");
			add_location(i2, file, 31, 162, 1539);
			attr_dev(span4, "class", "icon is-small");
			add_location(span4, file, 31, 134, 1511);
			add_location(span5, file, 31, 199, 1576);
			attr_dev(a2, "href", "/medios/canal-capital");
			attr_dev(a2, "class", "button is-rounded is-primary is-uppercase has-text-weight-bold is-control svelte-142tj0s");
			add_location(a2, file, 31, 20, 1397);
			attr_dev(i3, "data-feather", "share-2");
			add_location(i3, file, 32, 159, 1775);
			attr_dev(span6, "class", "icon is-small");
			add_location(span6, file, 32, 131, 1747);
			add_location(span7, file, 32, 196, 1812);
			attr_dev(a3, "href", "/medios/telecaribe");
			attr_dev(a3, "class", "button is-rounded is-primary is-uppercase has-text-weight-bold is-control svelte-142tj0s");
			add_location(a3, file, 32, 20, 1636);
			attr_dev(i4, "data-feather", "share-2");
			add_location(i4, file, 33, 157, 2012);
			attr_dev(span8, "class", "icon is-small");
			add_location(span8, file, 33, 129, 1984);
			add_location(span9, file, 33, 194, 2049);
			attr_dev(a4, "href", "/medios/canal-13");
			attr_dev(a4, "class", "button is-rounded is-primary is-uppercase has-text-weight-bold is-control svelte-142tj0s");
			add_location(a4, file, 33, 20, 1875);
			attr_dev(i5, "data-feather", "share-2");
			add_location(i5, file, 34, 152, 2239);
			attr_dev(span10, "class", "icon is-small");
			add_location(span10, file, 34, 124, 2211);
			add_location(span11, file, 34, 189, 2276);
			attr_dev(a5, "href", "/medios/tro");
			attr_dev(a5, "class", "button is-rounded is-primary is-uppercase has-text-weight-bold is-control svelte-142tj0s");
			add_location(a5, file, 34, 20, 2107);
			attr_dev(i6, "data-feather", "share-2");
			add_location(i6, file, 35, 158, 2470);
			attr_dev(span12, "class", "icon is-small");
			add_location(span12, file, 35, 130, 2442);
			add_location(span13, file, 35, 195, 2507);
			attr_dev(a6, "href", "/medios/teleislas");
			attr_dev(a6, "class", "button is-rounded is-primary is-uppercase has-text-weight-bold is-control svelte-142tj0s");
			add_location(a6, file, 35, 20, 2332);
			attr_dev(div1, "class", "column is-3 is-offset-7");
			add_location(div1, file, 30, 16, 1338);
			attr_dev(div2, "class", "columns controls svelte-142tj0s");
			add_location(div2, file, 25, 12, 777);
			attr_dev(div3, "class", "container");
			add_location(div3, file, 24, 8, 740);
			attr_dev(div4, "class", "hero-body");
			add_location(div4, file, 23, 1, 707);
			attr_dev(i7, "data-feather", "chevrons-left");
			add_location(i7, file, 42, 116, 2801);
			attr_dev(span14, "class", "icon is-small svelte-142tj0s");
			add_location(span14, file, 42, 88, 2773);
			add_location(span15, file, 42, 159, 2844);
			attr_dev(a7, "href", "/lobby");
			attr_dev(a7, "id", "volver");
			attr_dev(a7, "class", "button is-primary has-margin-bottom-50 svelte-142tj0s");
			add_location(a7, file, 42, 12, 2697);
			attr_dev(div5, "class", "container");
			add_location(div5, file, 41, 8, 2660);
			attr_dev(div6, "class", "hero-footer");
			add_location(div6, file, 40, 4, 2625);
			attr_dev(div7, "id", "lobby-medios");
			set_style(div7, "background", "url('lobby-stands.jpg')");
			attr_dev(div7, "class", "hero is-fullheight is-relative is-primary is-clipped svelte-142tj0s");
			add_location(div7, file, 22, 0, 575);
		},
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
