import { S as SvelteComponentDev, i as init, d as dispatch_dev, s as safe_not_equal, v as validate_slots, e as element, t as text, b as space, h as claim_element, j as children, c as detach_dev, k as claim_text, f as claim_space, l as attr_dev, n as add_location, m as set_style, o as insert_dev, p as append_dev, u as noop } from './client.e8614800.js';
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(i0, file, 28, 155, 1028);
			attr_dev(span0, "class", "icon is-small");
			add_location(span0, file, 28, 127, 1000);
			add_location(span1, file, 28, 192, 1065);
			attr_dev(a0, "href", "/medios/mintic");
			attr_dev(a0, "class", "button is-rounded is-primary is-uppercase has-text-weight-bold is-control svelte-z8dm2s");
			add_location(a0, file, 28, 20, 893);
			attr_dev(i1, "data-feather", "share-2");
			add_location(i1, file, 29, 153, 1251);
			attr_dev(span2, "class", "icon is-small");
			add_location(span2, file, 29, 125, 1223);
			add_location(span3, file, 29, 190, 1288);
			attr_dev(a1, "href", "/medios/rtvc");
			attr_dev(a1, "class", "button is-rounded is-primary is-uppercase has-text-weight-bold is-control svelte-z8dm2s");
			add_location(a1, file, 29, 20, 1118);
			attr_dev(div0, "class", "column is-2");
			add_location(div0, file, 27, 16, 846);
			attr_dev(i2, "data-feather", "share-2");
			add_location(i2, file, 32, 162, 1560);
			attr_dev(span4, "class", "icon is-small");
			add_location(span4, file, 32, 134, 1532);
			add_location(span5, file, 32, 199, 1597);
			attr_dev(a2, "href", "/medios/canal-capital");
			attr_dev(a2, "class", "button is-rounded is-primary is-uppercase has-text-weight-bold is-control svelte-z8dm2s");
			add_location(a2, file, 32, 20, 1418);
			attr_dev(i3, "data-feather", "share-2");
			add_location(i3, file, 33, 159, 1796);
			attr_dev(span6, "class", "icon is-small");
			add_location(span6, file, 33, 131, 1768);
			add_location(span7, file, 33, 196, 1833);
			attr_dev(a3, "href", "/medios/telecaribe");
			attr_dev(a3, "class", "button is-rounded is-primary is-uppercase has-text-weight-bold is-control svelte-z8dm2s");
			add_location(a3, file, 33, 20, 1657);
			attr_dev(i4, "data-feather", "share-2");
			add_location(i4, file, 34, 157, 2033);
			attr_dev(span8, "class", "icon is-small");
			add_location(span8, file, 34, 129, 2005);
			add_location(span9, file, 34, 194, 2070);
			attr_dev(a4, "href", "/medios/canal-13");
			attr_dev(a4, "class", "button is-rounded is-primary is-uppercase has-text-weight-bold is-control svelte-z8dm2s");
			add_location(a4, file, 34, 20, 1896);
			attr_dev(i5, "data-feather", "share-2");
			add_location(i5, file, 35, 152, 2260);
			attr_dev(span10, "class", "icon is-small");
			add_location(span10, file, 35, 124, 2232);
			add_location(span11, file, 35, 189, 2297);
			attr_dev(a5, "href", "/medios/tro");
			attr_dev(a5, "class", "button is-rounded is-primary is-uppercase has-text-weight-bold is-control svelte-z8dm2s");
			add_location(a5, file, 35, 20, 2128);
			attr_dev(i6, "data-feather", "share-2");
			add_location(i6, file, 36, 158, 2491);
			attr_dev(span12, "class", "icon is-small");
			add_location(span12, file, 36, 130, 2463);
			add_location(span13, file, 36, 195, 2528);
			attr_dev(a6, "href", "/medios/teleislas");
			attr_dev(a6, "class", "button is-rounded is-primary is-uppercase has-text-weight-bold is-control svelte-z8dm2s");
			add_location(a6, file, 36, 20, 2353);
			attr_dev(div1, "class", "column is-3 is-offset-7");
			add_location(div1, file, 31, 16, 1359);
			...
			add_location(i7, file, 43, 116, 2822);
			attr_dev(span14, "class", "icon is-small svelte-z8dm2s");
			add_location(span14, file, 43, 88, 2794);
			add_location(span15, file, 43, 159, 2865);
			attr_dev(a7, "href", "/lobby");
			attr_dev(a7, "id", "volver");
			attr_dev(a7, "class", "button is-primary has-margin-bottom-50 svelte-z8dm2s");
			add_location(a7, file, 43, 12, 2718);
			attr_dev(div5, "class", "container");
			add_location(div5, file, 42, 8, 2681);
			attr_dev(div6, "class", "hero-footer");
			add_location(div6, file, 41, 4, 2646);
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
